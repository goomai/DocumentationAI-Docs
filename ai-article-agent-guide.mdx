...
---
## Creating Your First Rank-Ready Article
...
**Select Your Project:&#x20;**&#x43;hoose which website or brand this article is for from the project dropdown. This helps the agent understand your brand context and maintain consistency. If you haven't set up projects yet, check our [project setup guide](https://claude.ai/chat/b8b888cd-8250-4229-a37e-036414628036#).
...
&#x20;\<Callout kind="warning" collapsed="false"> Choosing the right competitors is critical. Select articles that truly represent what you want to compete with, not just any top-ranking content. \</Callout>&#x20;

### **Deep Research Mode**

The agent now goes into research mode, analyzing:

- Search patterns and user intent

- Content structures that rank well
...
| ---------------------- | -------------------------------------------- | ------------------------------------------------------ |
| Entities               | Important people, places, products, concepts | "Google Analytics", "Digital Marketing"                |
| People Also Ask        | Questions from Google's PAA section          | "What is AI marketing?", "How does AI help marketing?" |
| Long-tail Keywords     | Specific, longer search phrases              | "AI marketing tools for small business"                |
| People Also Search For | Related terms users search for               | "Marketing automation", "AI chatbots"                  |
| Related Keywords       | Semantically connected terms                 | "Machine learning", "Personalization"                  |

&#x20;\<Expandable title="Understanding Keyword Types in Detail" default-open="false"> **Entities (Highest SEO Weight):** These are canonical terms that Google recognizes in its Knowledge Graph. Including these helps establish topical authority.&#x20;
...
**Related Keywords (Semantic Relevance):** Terms that help search engines understand the context and depth of your content. \</Expandable>
...
## Step 4: Title and Outline Generation
...
## Step 5: Final Article Creation

Once you approve the outline, the agent enters its final creation phase.

### **Content Research & Writing**

The agent:

- Conducts additional quick research for current information

- References your selected sources and citations

- Follows the optimized strategy based on competitor analysis

- Writes each section according to your specifications

### **Quality Assurance**

Before presenting the final draft, the agent automatically:

- **Checks SEO & AEO scores** to ensure ranking potential

- **Runs plagiarism detection** to avoid accidental copying

- **Validates humanization** to confirm natural, engaging writing

- **Optimizes structure** for search engine and answer engine visibility

### **Final Deliverables**

You'll receive:

- **Complete article draft** in the editor

- **Meta title and description** optimized for search

- **Structured data recommendations** for rich snippets

- **Performance score** showing ranking potential

### **Review and Polish**

Once you have your draft:

- Read through and make any necessary edits

- Ask the agent for specific changes or improvements

- Add your unique insights or brand-specific examples

- Export or publish when you're satisfied

&#x20;\<Callout kind="success" collapsed="false"> The agent creates a solid foundation, but your unique insights and examples make the content truly valuable and differentiated. \</Callout> \<Expandable title="Common Issues and Quick Fixes" default-open="false"> **"Content feels too generic"** - Add more specific details about your industry or audience - Include brand-specific examples and case studies - Ask the agent to focus on a particular angle or perspective&#x20;

**"Article is too long/short"**

- Adjust individual section word counts in the outline

- Remove or add sections as needed

- Specify desired length in your initial request

**"Tone doesn't match my brand"**

- Use more specific tone descriptions ("friendly but professional for B2B SaaS")

- Provide examples of your preferred writing style

- Edit key sections to match your brand voice

**"Missing important topics"**

- Review the outline carefully before content generation

- Add specific sections you need covered

- Use the research phase to ensure all important aspects are included \</Expandable>

---

## Tips for Best Results

&#x20;\<ExpandableGroup> \<Expandable title="Topic and Keyword Tips" default-open="true">&#x20;
...
&#x20;\<Callout kind="note" collapsed="false"> Specific topics lead to more focused, valuable content that ranks better and serves your audience's exact needs. \</Callout>&#x20;

**Include Target Keywords Early** The more specific you are with your initial input, the better your final results will be.

&#x20;\</Expandable> \<Expandable title="Research and Competition Tips" default-open="false">&#x20;
...
&#x20;\</Expandable> \<Expandable title="Content Creation Tips" default-open="false">&#x20;
...
&#x20;\<Callout kind="success" collapsed="false"> Articles that include personal insights, case studies, and brand-specific examples consistently outperform generic content. \</Callout> \</Expandable> \</ExpandableGroup>&#x20;
...
[**Start Creating Your Article**](https://claude.ai/chat/b8b888cd-8250-4229-a37e-036414628036#) | [**See Example Articles**](https://claude.ai/chat/b8b888cd-8250-4229-a37e-036414628036#) | [**Get Help**](https://claude.ai/chat/b8b888cd-8250-4229-a37e-036414628036#)
