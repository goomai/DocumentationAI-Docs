...
| Score Range | Result            | Interpretation                              | Color     |
| ----------- | ----------------- | ------------------------------------------- | --------- |
| **0-35%**   | **Human-written** | Natural writing patterns detected           | 🟢 Green  |
| **36-50%**  | **Likely Human**  | Some AI patterns but mostly natural writing | 🟡 Yellow |
| **51-65%**  | **Likely AI**     | Strong AI patterns with some human elements | 🟠 Amber  |
| **66-100%** | **AI-generated**  | Clear artificial writing patterns detected  | 🔴 Red    |

&#x20;\<Callout kind="success" collapsed="false"> Green and yellow scores indicate human-like writing. Amber and red scores suggest AI-generated patterns that may need improvement. \</Callout>
