...
| ----------- | ----------------- | ------------------------------------------- |
| **0-35%**   | **Human-written** | Natural writing patterns detected           |
| **36-50%**  | **Likely Human**  | Some AI patterns but mostly natural writing |
| **51-65%**  | **Likely AI**     | Strong AI patterns with some human elements |
| **66-100%** | **AI-generated**  | Clear artificial writing patterns detected  |
